...
class MHeadAttentionNotReduce(nn.Module):
    def __init__(self, n_in, n_out, att_activation, cla_activation, head_num=4):
        super(MHeadAttentionNotReduce, self).__init__()
...
if __name__ == "__main__":
    model = torch.nn.MultiheadAttention(embed_dim=128, num_heads=4, batch_first=True)
