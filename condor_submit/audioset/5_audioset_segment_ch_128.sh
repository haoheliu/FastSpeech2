...
python3 train.py -p config/audioset_segment_ch_128/preprocess.yaml -m config/audioset_segment_ch_128/model.yaml -t config/audioset_segment_ch_128/train.yaml