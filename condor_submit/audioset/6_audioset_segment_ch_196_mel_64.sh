...
python3 train.py -p config/audioset_segment_ch_192_mel_64/preprocess.yaml -m config/audioset_segment_ch_192_mel_64/model.yaml -t config/audioset_segment_ch_192_mel_64/train.yaml