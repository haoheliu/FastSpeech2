...
python3 train.py -p config/audioset_segment_ch_64/preprocess.yaml -m config/audioset_segment_ch_64/model.yaml -t config/audioset_segment_ch_64/train.yaml