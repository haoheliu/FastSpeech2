...
python3 train.py -p config/v2_audioset_segment_ch64_mel64/preprocess.yaml -m config/v2_audioset_segment_ch64_mel64/model.yaml -t config/v2_audioset_segment_ch64_mel64/train.yaml