...
python3 train.py -p config/audioset_segment_ch_64_mel_64_unbalanced/preprocess.yaml -m config/audioset_segment_ch_64_mel_64_unbalanced/model.yaml -t config/audioset_segment_ch_64_mel_64_unbalanced/train.yaml