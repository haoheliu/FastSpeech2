...
python3 train.py -p config/v3_audioset_segment_ch64_mel64_S100/preprocess.yaml -m config/v3_audioset_segment_ch64_mel64_S100/model.yaml -t config/v3_audioset_segment_ch64_mel64_S100/train.yaml