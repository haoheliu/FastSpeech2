...
python3 train.py -p config/v2_cliplabel/1_audioset_segment_ch64_mel64_S1000/preprocess.yaml -m config/v2_cliplabel/1_audioset_segment_ch64_mel64_S1000/model_s100.yaml -t config/v2_cliplabel/1_audioset_segment_ch64_mel64_S1000/train_v2_s100.yaml