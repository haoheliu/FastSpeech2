...
python3 train.py -p config/v2_cliplabel/2_audioset_clipnormpre_ch64_mel64_S100/preprocess.yaml -m config/v2_cliplabel/2_audioset_clipnormpre_ch64_mel64_S100/model.yaml -t config/v2_cliplabel/2_audioset_clipnormpre_ch64_mel64_S100/train.yaml