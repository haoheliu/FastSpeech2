...
python3 train.py -p config/v0_cliplabel_original/1_audioset_clipnormpre_ch64_mel64_S100/preprocess.yaml -m config/v0_cliplabel_original/1_audioset_clipnormpre_ch64_mel64_S100/model.yaml -t config/v0_cliplabel_original/1_audioset_clipnormpre_ch64_mel64_S100/train.yaml