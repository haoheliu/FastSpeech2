...
python3 train.py -p config/vggsound_1000_steps_low_8/preprocess.yaml -m config/vggsound_1000_steps_low_8/model.yaml -t config/vggsound_1000_steps_low_8/train.yaml